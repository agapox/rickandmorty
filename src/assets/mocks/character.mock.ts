import { Character, CharactersHttp } from "../../app/interfaces/character.interface";

export const GetCharactersHttpResMock: CharactersHttp = {
  "info": {
    "count": 671,
    "pages": 34,
...
export const GetCharacterHttpResMock: Character = {
  "id": 1,
  "name": "Rick Sanchez",
  "status": "Alive",
  "species": "Human",
...
export const CharactersArrayMock: Character[] = [
  {
      "id": 1,
      "name": "Rick Sanchez",
      "status": "Alive",
