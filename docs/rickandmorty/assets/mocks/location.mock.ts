import { Location, LocationsHttp } from "src/app/interfaces/location.interface";

export const GetLocationsHttpResMock: LocationsHttp = {
  "info": {
    "count": 108,
    "pages": 6,
...
export const GetLocationHttpResMock: Location = {
  "id": 1,
  "name": "Earth (C-137)",
  "type": "Planet",
  "dimension": "Dimension C-137",
...
export const LocationsArrayMock: Location[] = [];
