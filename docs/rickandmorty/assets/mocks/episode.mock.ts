import { Episode, EpisodesHttp } from "src/app/interfaces/episode.interface";

export const GetEpisodesHttpResMock: EpisodesHttp = {
  "info": {
    "count": 41,
    "pages": 3,
...
export const GetEpisodeHttpResMock: Episode = {
  "id": 1,
  "name": "Pilot",
  "air_date": "December 2, 2013",
  "episode": "S01E01",
...
export const EpisodesArrayMock: Episode[] = [];
